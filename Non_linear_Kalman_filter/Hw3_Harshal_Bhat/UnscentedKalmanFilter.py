...
import numpy as np
from ImageUtils import traj_plot, plot_rmse_loss, pos_ypr_plots, pos_ypr_ukf_plots
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        positions_plot, orientations_plot = pos_ypr_ukf_plots(interpolated_gt, cam_estimates, results, times)
